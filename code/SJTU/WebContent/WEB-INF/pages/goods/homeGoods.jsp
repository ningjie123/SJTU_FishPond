    ...
    <div class="slider-wapper">
        <div class="slider" style="height: 440px; touch-action: pan-y; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
            <ul class="slides" style="height: 400px;">
                <li class="active" style="opacity: 2;">
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                <p class="text1"><font size=6>Hello SJTUer：</font></p>
                                <br>
                                <p class="text2"><font size=6>欢迎来到SJTU鱼塘校园二手市场!</font></p>
